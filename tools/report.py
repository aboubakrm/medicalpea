#!/usr/bin/env python3
"""
Phase 4 — Conversation Visualizer (v5 - AI Studio Theme)
Usage:
    ...
    for t in turns:
        ...
        if t.get('linked_evidence'):
            ...
            for domain_key in sorted(list(set(t['linked_evidence']))):
                ...
                _, color_class = color_from_score(score, as_hex=True)
        ...
        <div class="turn turn-{t["who"].lower()}">
            ...
            <div class="message-content">
                <div class="message-header">{safe(t["who"])} • Turn #{t["turn"]}</div>
...
<title>Conversation Report — {safe(run_id)}</title>{css_block()}
</head><body>
  <div class="wrap">
      <header class="header">
